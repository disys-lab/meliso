#===================================================================================================
# DRIVER SCRIPT FOR PDHG  WITH ACCELERATED MVM USING MELISO+
#===================================================================================================
"""
@author: Huynh Quang Nguyen Vo
@affiliation: Oklahoma State University
This script demonstrates how to run primal-dual hybrid gradient (PDHG) using the MELISO+ framework 
for accelerated matrix-vector multiplication (MVM).
"""
import os
...
class PDHGSolver:
    ...
    def _compute_matvec(self, matrix: np.ndarray, vector: np.ndarray) -> np.ndarray:
        ...
        """
        self.mv_solver.solverObject.initializeMat(matrix) # Root process initializes the matrix 
        self.mv_solver.solverObject.initializeX(vector)   # Root process initializes the vector
        self.mv_solver.matVec(correction=True)
        self.mv_solver.finalize()
        self.mv_solver.acquireMCAStats()
        y = self.mv_solver.acquireResults()               # Root process acquires the result 
        self.mv_solver.finalize()
        return y
